# -*- coding: utf-8 -*-
"""Escalas_Corr_173577.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1a2Qnq2E3Y5OXw9N3r93zbEfQq6gI_xFY
...
"""Ejercicio: utiliza los siguientes datos para

1.   Elemento de lista
2.   Elemento de lista

generar la regresión lineal de cada modelo y la salida ordenala en una tupla con el sigueinte orden (pendiente, ordenada_al_origen, coef_de_correlacion_de_pearson)
...
def regresion_lineal_model_s():
  # Datos para Model S
    ...
    precios = np.array([89990, 91990, 93990, 95990, 97990])

    # Calcular medias
    x_mean = np.mean(años)
    y_mean = np.mean(precios)

    # Calcular pendiente (m)
    numerator = np.sum((años - x_mean) * (precios - y_mean))
    denominator = np.sum((años - x_mean)**2)
    m = numerator / denominator

    # Calcular ordenada al origen (b)
    b = y_mean - m * x_mean

    # Calcular coeficiente de correlación
    correlation_matrix = np.corrcoef(años, precios)
...
def regresion_lineal_model_x():
  # Datos para Model X
    años = np.array([2020, 2021, 2022, 2023, 2024])
    precios = np.array([99990, 101990, 103990, 105990, 107990])
...
def regresion_lineal_model_y():
  # Datos para Model Y
    años = np.array([2020, 2021, 2022, 2023, 2024])
    precios = np.array([44990, 46990, 48990, 50990, 52990])
...
# Calcular resultados para todos los modelos
model_s_results = regresion_lineal_model_s()
model_x_results = regresion_lineal_model_x()
model_y_results = regresion_lineal_model_y()

# Imprimir resultados ordenados
print("Resultados (pendiente, ordenada al origen, coeficiente de correlación):")
print(f"Model S: {model_s_results}")
print(f"Model X: {model_x_results}")
print(f"Model Y: {model_y_results}")
